...
def patch_eval_policy_source(source: str) -> str:
    ...
    source = _replace_once(
        ...
        "            task_feasibility_records = manifest_entry.get(\"expert_feasibility_records\")\n"
        "            if task_feasibility_records is not None:\n"
        "                manifest_feasibility_records = task_feasibility_records\n"
